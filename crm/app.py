...
ADMIN_WHATSAPP_TO = os.environ.get('ADMIN_WHATSAPP_TO', 'whatsapp:+919999999999')
...
# DEVELOPMENT CHANGE: This block is added back to run the app directly.
if __name__ == '__main__':
    # The db.create_all() is useful in development to create tables if they don't exist
